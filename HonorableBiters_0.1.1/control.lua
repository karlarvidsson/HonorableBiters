...
script.on_event({defines.events.on_player_left_game},
   function (e)
	...
	game.write_file("HonorableBiters.log", e.tick .. " on_player_left_game: " .. e.player_index .. " on force " .. forceName .. " get_cease_fire: " .. string.format("%s", game.forces["enemy"].get_cease_fire(forceName)) .. "\n", true, 0)
   end
)
